...
def test_with_newpassword():
    """Test database connection with password 'newpassword'"""
    try:
        ...
        if connection.is_connected():
            print("SUCCESS! Connected to MySQL with password 'newpassword'")
        ...
        print("You need to:")
        print("1. Run reset_mysql_password.bat to reset MySQL password")
        print("2. Or find your actual MySQL password")
        return False

if __name__ == "__main__":
    test_with_newpassword()
