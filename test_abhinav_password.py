...
def test_with_abhinav_password():
    """Test database connection with password 'Abhinav_444'"""
    try:
        ...
        if connection.is_connected():
            print("SUCCESS! Connected to MySQL with password 'Abhinav_444'")
...
def update_env_file(password):
    ...
    try:
        ...
        print(f"Updated .env file with password 'Abhinav_444'")
        
    except Exception as e:
        print(f"Could not update .env file: {e}")

if __name__ == "__main__":
    test_with_abhinav_password()
